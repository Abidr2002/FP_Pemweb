...
<head>
	...
	<title>LocRent Portal |Admin Motor </title>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
										...
										if ($result->num_rows > 0) {
											while ($row = mysqli_fetch_assoc($result)) {
												...
												<tr>
													...
													<td class="text-center">
														<?= "<img src='data:image/jpeg;base64," . base64_encode($gambar) . "' alt='$tipe' height='120' class='rounded'>"; ?>
													</td>
													<td class="text-center">
														<?= $row["tipe"] ?>
													</td>
													...
													<td class="text-center"><a
															href="edit-motor.php?id=<?php echo $row["id"]; ?>"><i
						...
						<a href="tambah-motor.php">
							<button type="button" class="btn btn-secondary" style="height:40px">Tambah Motor
							</button>
						</a>
					</div>
				</div>
		...
		function alert(id) {
			Swal.fire({
				...
				if (result.isConfirmed) {
					...
					location.href = 'motor.php?del=' + id;
				}
			})
		}
	</script>
